...
const instructionData = [
    {
        instruction: "Preheat your oven to 200°C | 400° F. Season chicken thighs with salt, pepper and dried thyme.",
        recipeId: 1
    },
    {
        instruction: 'Heat a large (34 cm or 13-14 inch) cast iron skillet (or heavy based oven-proof pan), over medium-high heat. When the skillet (or pan) is hot, add the oil. Sear the thighs, skin-side down, until skin is golden and crisp (about 4-5 minutes). Flip chicken and sear on the other side for a further 5 minutes.',
        recipeId: 1
    },
    {
        instruction: 'Melt the butter in the pan. Add the garlic until fragrant (about 30 seconds). Pour in the lemon juice, and sprinkle over fresh thyme leaves from 2 sprigs. Place another 2 sprigs around the chicken.',
        recipeId: 1
    },
    {
        instruction: 'Transfer skillet (or pan), to the oven and cook for 25-30 minutes, or until completely cooked through. Add the asparagus spears to the pan during the last 12 minutes of cook time.',
        recipeId: 1
    },
    {
        instruction: 'Garnish with lemon slices and leaves from the remaining sprig of thyme. Serve immediately.',
        recipeId: 1
    },
    {
